...
public class SourceCodeStructureHandler {
	...
	public String getSrcMainJava() {
		...
		String newpath = out + srcJava + pakStrcutre + File.separator + "main";
	...
	public String getSrcUtilsJava() {
		String srcJava = groupId + File.separator + "src" + File.separator + "main" + File.separator + "java"
				+ File.separator;
		String pakStrcutre = groupId.replace(".", File.separator);
		String newpath = out + srcJava + pakStrcutre + File.separator + "utils";
		if (new File(newpath).exists()) {
			return newpath + File.separator;
		}
		try {
	...
	public String getSrcPersistanceJava() {
		String srcJava = groupId + File.separator + "src" + File.separator + "main" + File.separator + "java"
				+ File.separator;
		String pakStrcutre = groupId.replace(".", File.separator);
		String newpath = out + srcJava + pakStrcutre + File.separator + "persistance";
		if (new File(newpath).exists()) {
			return newpath + File.separator;
		}
		try {
